...
ax1.scatter(theta, theta*0+A, c=Iorb(A,theta,rm[-1],phi,I0,w0,B), marker='o', s=100, cmap=cm, norm=norm)       #orbita
for i in rm:
    ax1.scatter(phi,i, color='y', marker='*', s=250, edgecolors='k', zorder=3)           #partícula
ax1.set_ylim(0, 175)
...
for i in rm:
    ...
    ax2.scatter(theta*180/np.pi, Iorb(A,theta,i,phi,I0,w0,B), c=colors, marker='o', s=10, cmap=cm, norm=norm)
